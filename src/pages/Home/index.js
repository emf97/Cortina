...
export default function Index() {
  ...
  useEffect(() => {
    async function fecthData() {
      await axios.get("https://cortina-automatizada-default-rtdb.firebaseio.com/janela.json").then((response) => {
  ...
  async function openWindow() {
    await axios.patch('https://cortina-automatizada-default-rtdb.firebaseio.com/janela.json',
      { estado: !state }
    )
